...
import 'package:sixam_mart/common/widgets/zone_vote_empty_state.dart';
...
class HomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload, {bool fromModule = false}) async {
    ...
    if (Get.find<SplashController>().module != null &&
      ...
      // NOTE: لسه بنجلب الكاتيجوري لأن بعض الموديولات بتستخدمها داخلياً
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SplashController>(builder: (splashController) {
      ...
      final bool showMobileModule =
          !ResponsiveHelper.isDesktop(context) && splashController.module == null && splashController.configModel!.module == null;

      final bool isParcel = splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.parcel;
      ...
      final bool isShop = splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.ecommerce;
      final bool isGrocery = splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.grocery;
      final bool isTaxi = splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.taxi;
                    ...
                    child: ResponsiveHelper.isDesktop(context)
                        ...
                        : CustomScrollView(
                            ...
                            slivers: [
                                    ...
                                    child: Row(
                                      children: [
                                        (splashController.module != null &&
                                            ...
                                            ? InkWell(
                                                onTap: () {
                                                  final a = AddressHelper.getUserAddressFromSharedPref();

                                                  final bool noZone = a == null ||
                                                      (a.zoneId == 0 && (a.zoneIds == null || a.zoneIds!.isEmpty));
                                                  final bool noModules = (splashController.moduleList?.isEmpty ?? true);

                                                  // إذا ما في Modules أو خارج التغطية -> افتح شاشة Set Location
                                                  if (noModules || noZone) {
                                          ...
                                          child: Container(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Icon(CupertinoIcons.search, size: 25, color: Theme.of(context).primaryColor),
                                ...
                                child: Center(
                                  child: SizedBox(
                                    ...
                                    child: Builder(builder: (context) {
                                      ...
                                      final bool noZone = address != null &&
                                          ((address.zoneId ?? 0) == 0) &&
                                          (address.zoneIds == null || address.zoneIds!.isEmpty);

                                      final bool noModules =
                                          (splashController.moduleList == null) || splashController.moduleList!.isEmpty;

                                      // ✅ إذا ما في تغطية أو ما في Modules: اعرض صفحة التصويت بدل الفراغ
                                      if (showMobileModule && (noZone || noModules)) {
                                        return ZoneVoteEmptyState(
                                          title: 'no_module_found'.tr,
                                          subtitle:
                                              'Tap below to vote for your area and tell us which restaurants/shops you want. We’ll use this to prioritize onboarding.',
                                          ctaText: 'Vote for your area',
                                          onTap: () {
                                            final a = AddressHelper.getUserAddressFromSharedPref();

                                            if (a != null &&
                                                (a.latitude?.isNotEmpty ?? false) &&
                                                (a.longitude?.isNotEmpty ?? false)) {
                                              Get.toNamed(
                                                RouteHelper.getZoneVoteWizardRoute(lat: a.latitude, lng: a.longitude),
                                                arguments: {
                                                  'lat': a.latitude,
                                                  'lng': a.longitude,
                                                  'address': a.address,
                                            ...
                                            // fallback: إذا ما في lat/lng محفوظين
                                            Get.toNamed(RouteHelper.getAccessLocationRoute('home'));
                                          },
                                          assetPath: 'assets/image/zone_vote.gif',
                                        );
                                      }

                                      // الوضع الطبيعي
                                      return !showMobileModule
                                          ? Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                isGrocery
                              ...
                              /// ✅ AllStoreFilterWidget يظهر فقط إذا عندنا Stores (مو بحالة No stores/No zone)
                              !showMobileModule && !isTaxi
                                  ? GetBuilder<StoreController>(builder: (storeController) {
                                      final bool noStores = storeController.storeModel != null &&
                                          ((storeController.storeModel!.totalSize ?? 0) == 0);

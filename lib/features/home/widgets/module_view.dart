    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      GetBuilder<AddressController>(builder: (locationController) {
        ...
        if (AuthHelper.isLoggedIn() && locationController.addressList != null) {
          ...
          // 🔒 حماية من null في عنوان المستخدم
          final AddressModel? userSavedAddress = AddressHelper.getUserAddressFromSharedPref();

          if (userSavedAddress != null && userSavedAddress.id != null) {
            for (int index = 0; index < locationController.addressList!.length; index++) {
              if (locationController.addressList![index].id == userSavedAddress.id) {
                contain = true;
                break;
              }
            }
          ...
          if (!contain && userSavedAddress != null) {
            addressList.add(userSavedAddress);
          }
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final AddressModel? selectedAddress = addressList[index];
                  final AddressModel? userSavedAddress = AddressHelper.getUserAddressFromSharedPref();
                  ...
                  return Container(
                    ...
                    child: AddressWidget(
                      ...
                      fromAddress: false,
                      onTap: () {
                        // 🔒 تأكد أن العنوانين غير null قبل المقارنة
                        if (userSavedAddress != null &&
                            selectedAddress != null &&
                            userSavedAddress.id != selectedAddress.id) {
                          Get.dialog(

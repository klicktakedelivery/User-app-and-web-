...
class _BestReviewItemViewState extends State<BestReviewItemView> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ItemController>(builder: (itemController) {
      final List<Item>? reviewItemList = itemController.reviewedItemList;

      if (reviewItemList == null) {
        return const BestReviewItemShimmer();
      }
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final item = reviewItemList[index];
                ...
                return Padding(
                  ...
                  child: CustomInkWell(
                    ...
                    child: ReviewItemCard(item: item),
                  ),
                );
              },
            ),

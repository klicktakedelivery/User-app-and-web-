...
class ApiClient extends GetxService {
  ...
  Map<String, String> updateHeader(String? token, List<int>? zoneIDs, List<int>? operationIds, String? languageCode, int? moduleID, String? latitude, String? longitude, {bool setHeader = true}) {
    ...
    debugPrint('HEADER_DBG moduleID(arg)=$moduleID cacheModuleId(sp)=${sharedPreferences.getString(AppConstants.cacheModuleId)} finalHeaderModule=${header[AppConstants.moduleId]} zoneIDs=$zoneIDs lat=$latitude lng=$longitude');

...
class WebMenuBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    // ✅ نقرأ العنوان مرة واحدة وبشكل آمن
    final userAddress = AddressHelper.getUserAddressFromSharedPref();

    return Column(
      children: [

        // الشريط العلوي: الموقع + اللغة + الثيم
        Container(
          height: 40,
                      ...
                      child: Padding(
                        ...
                        child: GetBuilder<LocationController>(
                            builder: (locationController) {
                              // تجهيز بيانات العنوان والأيقونة بشكل آمن
                              final addressType =
                              ...
                              if (AuthHelper.isLoggedIn()) {
                                if (addressType == 'home') {
                                  locationIcon = Icons.home_filled;
        ...
        // الشريط الثاني: اللوجو + القوائم + الأيقونات
        Container(
          width: double.infinity,
          color: Theme.of(context).cardColor,

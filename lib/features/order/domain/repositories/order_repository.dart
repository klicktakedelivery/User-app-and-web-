...
class OrderRepository implements OrderRepositoryInterface {
  ...
  Future<bool> cancelOrder({
    ...
    // نبني قيمة reason النهائية اللي هنرسلها للـ API
    String finalReason = '';

    if (isParcel) {
      // في حالة الطلبات الـ parcel ندمج الأسباب + التعليق في نص واحد
      ...
      // الطلب العادي: لو السبب الجاهز فاضي، نستخدم التعليق كـ reason
    ...
    Map<String, dynamic> data = {
      '_method': 'put',
      'order_id': orderID,
      'reason': finalReason,   // هذا اللي يهم الباك-إند
      'note': comment ?? '',   // لو حابب تحتفظ به أيضًا
    };

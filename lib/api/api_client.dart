...
class ApiClient extends GetxService {
  ...
  Map<String, String> updateHeader(
    ...
    // ✅ لا ترسل Authorization إذا ما في توكن صالح (خصوصاً للضيف)
    ...
    if (setHeader) {
      ...
      debugPrint(
        'HEADER_DBG moduleID(arg)=$moduleID cacheModuleId(sp)=${sharedPreferences.getString(AppConstants.cacheModuleId)} '
        'finalHeaderModule=${header[AppConstants.moduleId]} zoneIDs=$zoneIDs lat=$latitude lng=$longitude',
      );
    }
    return header;
  }
